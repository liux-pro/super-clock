...
#include "hal_data.h"
kint_instance_ctrl_t g_kint1_ctrl;
const keymatrix_cfg_t g_kint1_cfg =
{ .channel_mask = 0, .trigger = KEYMATRIX_TRIG_RISING, .ipl = (2), .irq = VECTOR_NUMBER_KEY_INT, .p_callback =
          kint_callback,
  .p_context = NULL, .p_extend = NULL };

/* Instance structure to use this module. */
const keymatrix_instance_t g_kint1 =
{ .p_ctrl = &g_kint1_ctrl, .p_cfg = &g_kint1_cfg, .p_api = &g_keymatrix_on_kint };
kint_instance_ctrl_t g_kint0_ctrl;
const keymatrix_cfg_t g_kint0_cfg =
{ .channel_mask = 0, .trigger = KEYMATRIX_TRIG_RISING, .ipl = (2), .irq = VECTOR_NUMBER_KEY_INT, .p_callback =
          kint_callback,
  .p_context = NULL, .p_extend = NULL };

/* Instance structure to use this module. */
const keymatrix_instance_t g_kint0 =
{ .p_ctrl = &g_kint0_ctrl, .p_cfg = &g_kint0_cfg, .p_api = &g_keymatrix_on_kint };
