...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] = { { .pin = BSP_IO_PORT_01_PIN_01,
		...
		{ .pin = BSP_IO_PORT_01_PIN_03, .pin_cfg =
				...
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_CTSU) }, { .pin =
				...
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_CTSU) }, { .pin =
				BSP_IO_PORT_02_PIN_12, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_SCI1_3_5_7_9) }, { .pin =
				BSP_IO_PORT_02_PIN_13, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_SCI1_3_5_7_9) }, { .pin =
